...
# 지역별 추천 데이터 (더 많은 지역 추가, 이름과 깃발 모양 표시)
regions = {
    ...
    "광주": {"coords": [35.1595, 126.8526], "famous": ["5.18 기념공원", "충장로"], "food": ["광주 떡갈비", "김치"], "activity": ["문화예술 체험", "시내 산책"], "image": "https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Gwangju_City.jpg/800px-Gwangju_City.jpg"}
}
